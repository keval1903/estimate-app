    ...
    <div className="app-container">
      ...
      <div className="page">
        ...
        <button className="home-btn" onClick={() => navigate('/estimate/new')}>
          ...
          <div>
            <div className="home-btn-text">CREATE NEW ESTIMATE</div>
            <div className="home-btn-sub">Start a fresh bill for a site</div>
          </div>
        </button>
        ...
        <button className="home-btn" onClick={() => navigate('/products')}>
          ...
          <div>
            ...
            <div className="home-btn-sub">Add, edit or update product rates</div>
          </div>
        </button>

        <button className="home-btn" onClick={() => navigate('/estimates')}>
